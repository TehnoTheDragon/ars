// use std::{io::Write as IoWrite, vec};
...
build_kinds!(MyToken, Whitespace, Colon, Comma, Percent, Hashtag, Instruction, Ident, Number);
build_kinds!(MyNode, Label, Instruction, Ident, Register, Constant);

fn main() {
    println!("{}", MyNode::Label);
}